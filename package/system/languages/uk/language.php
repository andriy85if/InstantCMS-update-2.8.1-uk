<?php
    ...
    define('LANG_CONTENT_SELECT_ITEM',       'Обрати %s');
    define('LANG_CONTENT_ADD_ITEM',          'Додати %s');
    define('LANG_CONTENT_BIND_ITEM',         'Привʼязати %s');
    define('LANG_CONTENT_BIND_ITEMS',        'Привʼязати');
    define('LANG_CONTENT_UNBIND_ITEM',       'Відвʼязати %s');
    define('LANG_CONTENT_UNBIND_ITEMS',      'Відвʼязати');
    ...
    define('LANG_CONTENT_BIND_ITEM_FIND_HINT','Введіть частину значення');
    define('LANG_CONTENT_OWN_ITEMS',		  'Тільки мої');
    ...
    define('LANG_MOBILE_DEVICES',  'Телефони');

    //PARSERS
    define('LANG_PARSER_LIST_IS_AUTOLINK',     'Автопосилання');
    define('LANG_PARSER_LIST_IS_AUTOLINK_HINT', 'Увімкнення цієї опції розбиває (за комою) значення поля на окремі слова і кожне робить посиланням. ');
    define('LANG_PARSER_LIST_IS_AUTOLINK_FILTER', 'Повинен бути увімкнений показ поля в фільтрі.');
    define('LANG_PARSER_BITMASK_CHECKBOX_MULTIPLE', 'Мультивибір чекбоксами');
    define('LANG_PARSER_BITMASK_LIST_CLASS', 'Клас списку');
    ...
    define('LANG_PARSER_URL_TITLE',          'Можливість встановити заголовок для посилання');
    define('LANG_PARSER_URL_NOFOLLOW',       'Додавати атрибут rel="nofollow"');
    define('LANG_PARSER_URL_CSS_CLASS',      'CSS клас посилання');
    define('LANG_PARSER_URL_TITLE_HINT',     'Для відображення назви посилання, введіть його назву через знак "|", наприклад: http://yandex.ru|Яндекс');
    ...
    define('LANG_PARSER_PARENT',             'Батьківський елемент');
    ...
    define('LANG_PARSER_IMAGE_DELETE',       'Видалити зображення з серверу?');
    define('LANG_PARSER_COLOR',              'Колір');
    define('LANG_PARSER_COLOR_CT',           'Тип блоку вибору кольору');
    define('LANG_PARSER_COLOR_CT_HUE',       'Відтінок');
    define('LANG_PARSER_COLOR_CT_SATURATION', 'Насиченість');
    define('LANG_PARSER_COLOR_CT_BRIGHTNESS', 'Яскравість');
    define('LANG_PARSER_COLOR_CT_WHEEL',     'Коло');
    define('LANG_PARSER_COLOR_CT_SWATCHES',  'Тільки передвстановленні значення');
    define('LANG_PARSER_COLOR_CT_SWATCHES_OPT', 'Передвстановленні значення');
    ...
    define('LANG_PARSER_FILE_LABEL_COUNTER', 'завантажений');
    ...
    define('LANG_PARSER_FILE_SHOW_COUNTER',  'Показувати лічильник завантажень');
    ...
    define('LANG_MODERATION_SUCCESS',        'Перевірено');
    ...
    define('LANG_MODERATION_NOTIFY',         'Нова сторінка очікує Вашої перевірки');
    ...
    define('LANG_PERM_OPTION_TO_OWN',        'Тільки в своїх');
    define('LANG_PERM_OPTION_TO_OTHER',      'Тільки в чужих');
    define('LANG_PERM_OPTION_TO_ALL',        'У всіх');
    define('LANG_PERM_OPTION_OWN_TO_OWN',    'Свої до своїх');
    define('LANG_PERM_OPTION_OWN_TO_OTHER',  'Свої до чужих');
    define('LANG_PERM_OPTION_OWN_TO_ALL',    'Свої до всіх');
    define('LANG_PERM_OPTION_OTHER_TO_OWN',  'Чужі до своїх');
    define('LANG_PERM_OPTION_OTHER_TO_OTHER','Чужі до чужих');
    define('LANG_PERM_OPTION_OTHER_TO_ALL',  'Чужі до всіх');
    define('LANG_PERM_OPTION_ALL_TO_OWN',    'Всі до своїх');
    define('LANG_PERM_OPTION_ALL_TO_OTHER',  'Всі до чужих');
    define('LANG_PERM_OPTION_ALL_TO_ALL',    'Всі до всіх');
    define('LANG_SHOW_TO_GROUPS',            'Показувати групам');
    define('LANG_HIDE_FOR_GROUPS',           'Не показувати групам');
    define('LANG_SHOW_TO_COUNTRIES',         'Показувати для країн');
    define('LANG_HIDE_TO_COUNTRIES',         'Не показувати для країн');
    define('LANG_ACCESS_DENIED',             'Доступ заборонений');
    define('LANG_ACCESS_GROUP_HINT',         'Групам, до яких ви належите, заборонений доступ до цієї сторінки');
    define('LANG_ACCESS_COUNTRY_HINT',       'Ця сторінка недоступна для перегляду в вашій країні');
    ...
    define('ERR_CLASS_NOT_DEFINED', 		 'В файлі %s не визначений клас <b>%s</b>');
    ...
    define('ERR_FORBIDDEN', 		 	     'Доступ заборонений');
    ...
    define('LANG_TARGET_LIST_EMPTY',         'Немає %s для відображення');
    ...
    define('LANG_RESTORE', 					 'Відновити');
	define('LANG_DELETE', 					 'Видалити');
    define('LANG_DELETE_SUCCESS', 	         'Допис успішно видалений');
    define('LANG_BASKET_TITLE', 			 'Кошик матеріалів');
    define('LANG_BASKET_DELETE', 			 'Видалити в кошик');
    define('LANG_BASKET_DELETE_SUCCESS', 	 'Допис успішно видалений в кошик');
    define('LANG_BASKET_DELETE_LEFT_TIME', 	 'Матеріал буде в кошику %s, після чого видалиться остаточно');
    define('LANG_ITEM_RESTORE_SUCCESS', 	 'Допис успішно відновлений');
	define('LANG_DELETE_SELECTED',			 'Видалити виділені');
	define('LANG_DELETE_SELECTED_CONFIRM',   'Видалити виділені елементи?');
    define('LANG_TRASH_DELETE_SELECTED_CONFIRM', 'Видалити виділені елементи в кошик?');
    ...
    define('LANG_SELECT_MULTIPLE',           'Вибрати декілька');
	...
	define('LANG_SHOW_MORE',                 'Показати більше');
	define('LANG_RETURN_TO_FIRST',           'Повернутися до початку');
    ...
    define('LANG_PRIVACY_HINT',              'Це приватний допис');
    ...
    define('LANG_TIME2',                     'рази');
    define('LANG_TIME10',                    'разів');
    define('LANG_SUBSCRIBERS_SPELL',         'підписник|підписника|підписників');
    define('LANG_DOWNLOAD_SPELL',            'завантаження|завантаження|завантажень');
    ...
    define('LANG_DEBUG_QUERY_TIME',          'Час виконання');
    define('LANG_DEBUG',                     'Відладка');
    define('LANG_DEBUG_TAB_DB',              'SQL');
    define('LANG_DEBUG_TAB_CACHE',           'Кеш');
    define('LANG_DEBUG_TAB_EVENTS',          'Події');
    define('LANG_DEBUG_TAB_WIDGETS',         'Віджети');
    define('LANG_DEBUG_TAB_INCLUDES',        'Підключені файли');
